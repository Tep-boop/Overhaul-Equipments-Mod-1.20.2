...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.RED_GRANITE);
        addDrop(ModBlocks.DEEPSLATE_FURNACE);
        addDrop(ModBlocks.DEST_IRON_BLOCK);

        addDrop(ModBlocks.DEST_IRON_ORE, oreDrops(ModBlocks.DEST_IRON_ORE, ModItems.RAW_DEST_IRON));
        addDrop(ModBlocks.DEEPSLATE_DEST_IRON_ORE, oreDrops(ModBlocks.DEEPSLATE_DEST_IRON_ORE, ModItems.RAW_DEST_IRON));
    }
}
